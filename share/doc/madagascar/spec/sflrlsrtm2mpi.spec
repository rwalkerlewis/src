[sflrlsrtm2mpi]
Cat:    RSF/user/jsun
Desc:   2-D Low-rank One-step Least Pre-stack Reverse-Time-Migration in the complex domain (both img and data are complex valued) without MPI
DocCmd: sflrlsrtm2mpi | cat
...
Param:  gpl int  -   -  		
Param:  gpz int  -   -  		
Param:  illum enum-bool  -  y 		if n, no source illumination 
Param:  lft int  -  40 		

...
Port:   eta rsf r  -  		auxiliary input file name (containing unspecified data)
...
Port:   vnmo rsf r  -  		auxiliary input file name (containing unspecified data)
Port:   vz rsf r  -  		auxiliary input file name (containing unspecified data)

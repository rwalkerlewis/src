[sfpsp]
Cat:    RSF/user/jsun
Desc:   Pseudo-spectral wave extrapolation/migration using second-order two-way wave equation
DocCmd: sfpsp | cat
...
LDesc:  (defaults to: ct)
Param:  ct float  -   -  		
Param:  dat string  -   -  		auxiliary input file name
...
Param:  mig enum-bool  -  n 		use pseudo-spectral 

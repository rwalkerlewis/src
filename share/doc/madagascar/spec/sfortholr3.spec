[sfortholr3]
Cat:    RSF/user/jsun
Desc:   Lowrank decomposition for 3-D orthorhombic wave propagation (Real)
DocCmd: sfortholr3 | cat
...
Param:  approx   -   -  		Type of approximation (0=exact 1=zone 2=acoustic 3=tsvankin)
LDesc:  (defaults to: 2)
Param:  dt   -   -  		time step
Param:  eps   -   -  		tolerance

[sfeikds]
Cat:    RSF/user/tariq
Desc:   Source differntial eikonal solver (3-D)
DocCmd: sfeikds | cat
...
Param:  dl float  -  0.0 		The value of the shift in the y direction 
...
Param:  sorder int  -  2 		Accuracy order of the source perturbation
Param:  xshot float  -   -  		

[sfsglfd1pml]
Cat:    RSF/user/fangg
Desc:   1-D Lowrank Finite-difference wave extrapolation
DocCmd: sfsglfd1pml | cat
...
Port:   sx rsf r  -  		auxiliary input file name (containing unspecified data)
...
Param:  gdep float  -  0.0 		depth of geophone 

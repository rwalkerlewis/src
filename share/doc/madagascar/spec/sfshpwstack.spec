...
Param:  eps1 float  -  0.01 		stretch regularization 
...
Param:  nmo enum-bool  -  n 		if y, apply constant velocity NMO 
...
Param:  velocity float  -   -  		constant velocity 

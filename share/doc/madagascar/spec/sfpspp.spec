[sfpspp]
Cat:    RSF/user/jsun
Desc:   Pseudo-spectral wave extrapolation for second-order two-way wave equation using wavefield injection for passive imaging
DocCmd: sfpspp | cat
...
LDesc:  (defaults to: ct)
Param:  ct float  -   -  		
Param:  dat_v string  -   -  		auxiliary output file name
Param:  dt float  -   -  		
...
Param:  wave string  -   -  		auxiliary input file name

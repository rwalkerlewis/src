[sfktmig]
Cat:    RSF/user/bash
Desc:   Prestack time migration (2-D/3-D) for irregular data
DocCmd: sfktmig | cat
...
Param:  dbtr int  -  1000 		Number of input traces to read at once 
...
Param:  time enum-bool  -  n 		Measure execution time 

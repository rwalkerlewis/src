...
Desc:   Fast sweeping factored TTI eikonal solver (2D)
DocCmd: sffacttieikonal | cat
...
Param:  fac int  -  1 		Type of factorization: (0)Additive, (1)Multiplicative 
Param:  nfpi int  -  3 		number of fixed-point iterations 
Param:  niter int  -  4 		number of sweeping iterations 
Param:  optloc enum-bool  -  n 		Selects optimal location for homogeneous medium parameter 
